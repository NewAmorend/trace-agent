...
> **Status:** v0.1.0 in progress — see the
> [v0.1.0 roadmap issue](https://github.com/NewAmorend/trace-agent/issues/1)
> (or [`docs/roadmap.md`](docs/roadmap.md)) for the path to a calibrated
> analyzer with real `verified_pass` numbers.
